  ...
  <app-section>
    ...
    <el-form inline :model="form" class="toolbar">
      <el-form-item label="配置键">
        <el-input v-model="form.settingKey" placeholder="如 max_file_size" />
      </el-form-item>
      <el-form-item label="配置值">
        <el-input v-model="form.settingValue" placeholder="如 20MB" />
      </el-form-item>
      <el-form-item>
...
async function loadRows() {
  loading.value = true;
  try {
    rows.value = await fetchPlatformSettings("UPLOAD");
  } catch (error) {
